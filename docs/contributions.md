...
| :sparkles: | :bug: | :hammer_and_wrench: | :toolbox: | :arrows_counterclockwise: | :memo: | :zap: | :recycle: | :rewind: | :art: | :test_tube: |
| :-------------------: | :-------------------: | :---------------------: | :----------------------: | :-----------------: | :-------------------: | :--------------------: | :-----------------------: | :---------------------: | :---------------------: | :--------------------: |
| 7 | 10 | 0 | 15 | 0 | 64 | 0 | 0 | 0 | 1 | 1 |
...
### [`next.js`](https://github.com/vercel/next.js) ![GitHub Repo Stars](https://img.shields.io/github/stars/vercel/next.js)
...
1. fix: `next info` command does not output the versions of `npm` `yarn` and `pnpm` correctly [#71134](https://github.com/vercel/next.js/pull/71134) :purple_heart:
...
1. docs: fix broken links and add some links in `distribute-tasks.md` [#4107](https://github.com/lerna/lerna/pull/4107) :purple_heart:
1. docs: fix simple typos in `import/README.md` [#4115](https://github.com/lerna/lerna/pull/4115) :purple_heart:

## [`llvm`](https://github.com/llvm)

### [`llvm-project`](https://github.com/llvm/llvm-project) ![GitHub Repo Stars](https://img.shields.io/github/stars/llvm/llvm-project)
