...
| ${typeToTitle('feat', { title: false })} | ${typeToTitle('fix', { title: false })} | ${typeToTitle('build', { title: false })} | ${typeToTitle('chore', { title: false })} | ${typeToTitle('ci', { title: false })} | ${typeToTitle('docs', { title: false })} | ${typeToTitle('perf', { title: false })} | ${typeToTitle('refactor', { title: false })} | ${typeToTitle('revert', { title: false })} | ${typeToTitle('style', { title: false })} | ${typeToTitle('test', { title: false })} |
| :-------------------: | :-------------------: | :---------------------: | :----------------------: | :-----------------: | :-------------------: | :--------------------: | :-----------------------: | :---------------------: | :---------------------: | :--------------------: |
| ${ch.countAllMergedPullRequestsByType('feat')} | ${ch.countAllMergedPullRequestsByType('fix')} | ${ch.countAllMergedPullRequestsByType('build')} | ${ch.countAllMergedPullRequestsByType('chore')} | ${ch.countAllMergedPullRequestsByType('ci')} | ${ch.countAllMergedPullRequestsByType('docs')} | ${ch.countAllMergedPullRequestsByType('perf')} | ${ch.countAllMergedPullRequestsByType('refactor')} | ${ch.countAllMergedPullRequestsByType('revert')} | ${ch.countAllMergedPullRequestsByType('style')} | ${ch.countAllMergedPullRequestsByType('test')} |
